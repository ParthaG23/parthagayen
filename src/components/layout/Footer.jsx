...
export default function Footer({ dark }) {
  return (
    <footer className="relative py-16 px-6 transition-colors duration-500 bg-gray-100 dark:bg-[#0f0f0f]">
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-12">
        ...
        <div>
          ...
          <a
            href="/resume.pdf"
            download
            className="inline-block mt-6 px-6 py-3 border-2 border-lime-500 rounded-full text-sm font-semibold hover:bg-lime-500 hover:text-black transition"
          >
            Download CV
          </a>
        </div>
      ...
      {/* ================= BOTTOM ================= */}
      <div className="border-t border-gray-300 dark:border-white/10 mt-12 pt-6 text-center text-sm opacity-60">
